...
impl TranslateRiscv {
    pub fn translate_fld(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        ...
        (false, vec![tcg_call_op, result_cmp_op, exit_tb, tcg_set_label])

        // Self::translate_float_rri(TCGOpcode::LOAD_FLOAT_64BIT, inst)
    }
    pub fn translate_flw(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let imm_const: u64 = ((inst.inst as i32) >> 20) as u64;
    ...
    pub fn translate_fsd(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let imm_const: u64 = ((inst.inst as i32) >> 20) as u64;
    ...
    pub fn translate_fsw(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let imm_const: u64 = ((inst.inst as i32) >> 20) as u64;
    ...
    pub fn translate_fadd_d(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
    ...
    pub fn translate_fsub_d(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fmul_d(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fmadd_d(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        ...
        let fop = TCGOp::new_helper_call_arg4(
            CALL_HELPER_IDX::CALL_FMADD_D_IDX as usize, *rd, *rs1, *rs2, *rs3);        (false, vec![fop])
    }

    pub fn translate_fmsub_d(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rs3 = Box::new(TCGv::new_reg(get_rs3_addr!(inst.inst) as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
        ...
        let fop = TCGOp::new_helper_call_arg4(
            CALL_HELPER_IDX::CALL_FMSUB_D_IDX as usize, *rd, *rs1, *rs2, *rs3);        (false, vec![fop])
    }

    pub fn translate_fnmsub_d(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rs3 = Box::new(TCGv::new_reg(get_rs3_addr!(inst.inst) as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
        ...
        let fop = TCGOp::new_helper_call_arg4(
            CALL_HELPER_IDX::CALL_FNMSUB_D_IDX as usize, *rd, *rs1, *rs2, *rs3);        (false, vec![fop])
    }

    pub fn translate_fnmadd_d(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rs3 = Box::new(TCGv::new_reg(get_rs3_addr!(inst.inst) as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
        ...
        let fop = TCGOp::new_helper_call_arg4(
            CALL_HELPER_IDX::CALL_FNMADD_D_IDX as usize, *rd, *rs1, *rs2, *rs3);        (false, vec![fop])
    }

    pub fn translate_fdiv_d(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fsqrt_d(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fmv_x_d(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fmv_d_x(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_feq_d(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_flt_d(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fle_d(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fclass_d(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fmax_d(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fmin_d(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fsgnj_d(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fsgnjn_d(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fsgnjx_d(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fadd_s(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fsub_s(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fmul_s(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fmadd_s(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rs3 = Box::new(TCGv::new_reg(get_rs3_addr!(inst.inst) as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fmsub_s(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rs3 = Box::new(TCGv::new_reg(get_rs3_addr!(inst.inst) as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fnmsub_s(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rs3 = Box::new(TCGv::new_reg(get_rs3_addr!(inst.inst) as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fnmadd_s(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rs3 = Box::new(TCGv::new_reg(get_rs3_addr!(inst.inst) as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fdiv_s(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fsqrt_s(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fmv_x_s(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fmv_s_x(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_feq_s(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_flt_s(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fle_s(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fclass_s(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fmv_x_w(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fmv_w_x(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fmax_s(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fmin_s(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fsgnj_s(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fsgnjn_s(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fsgnjx_s(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) {
        let rs1 = Box::new(TCGv::new_reg(get_rs1_addr!(inst.inst) as u64));
        let rs2 = Box::new(TCGv::new_reg(get_rs2_addr!(inst.inst)as u64));
        let rd = Box::new(TCGv::new_reg(get_rd_addr!(inst.inst) as u64));
    ...
    pub fn translate_fcvt_w_s (&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) { 
    ...
    pub fn translate_fcvt_wu_s(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) { 
        let mut tcg_lists = vec![];
        let rs1 = TCGv::new_reg(get_rs1_addr!(inst.inst) as u64);
        let rd  = TCGv::new_reg(get_rd_addr!(inst.inst) as u64);
    ...
    pub fn translate_fcvt_s_w (&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) { 
        let mut tcg_lists = vec![];
        let rs1 = TCGv::new_reg(get_rs1_addr!(inst.inst) as u64);
        let rd  = TCGv::new_reg(get_rd_addr!(inst.inst) as u64);
    ...
    pub fn translate_fcvt_s_wu(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) { 
        let mut tcg_lists = vec![];
        let rs1 = TCGv::new_reg(get_rs1_addr!(inst.inst) as u64);
        let rd  = TCGv::new_reg(get_rd_addr!(inst.inst) as u64);
    ...
    pub fn translate_fcvt_s_d (&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) { 
        let mut tcg_lists = vec![];
        let rs1 = TCGv::new_reg(get_rs1_addr!(inst.inst) as u64);
        let rd  = TCGv::new_reg(get_rd_addr!(inst.inst) as u64);
    ...
    pub fn translate_fcvt_d_s (&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) { 
        let mut tcg_lists = vec![];
        let rs1 = TCGv::new_reg(get_rs1_addr!(inst.inst) as u64);
        let rd  = TCGv::new_reg(get_rd_addr!(inst.inst) as u64);
    ...
    pub fn translate_fcvt_w_d (&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) { 
        let mut tcg_lists = vec![];
        let rs1 = TCGv::new_reg(get_rs1_addr!(inst.inst) as u64);
        let rd  = TCGv::new_reg(get_rd_addr!(inst.inst) as u64);
    ...
    pub fn translate_fcvt_wu_d(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) { 
        let mut tcg_lists = vec![];
        let rs1 = TCGv::new_reg(get_rs1_addr!(inst.inst) as u64);
        let rd  = TCGv::new_reg(get_rd_addr!(inst.inst) as u64);
    ...
    pub fn translate_fcvt_d_w (&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) { 
        let mut tcg_lists = vec![];
        let rs1 = TCGv::new_reg(get_rs1_addr!(inst.inst) as u64);
        let rd  = TCGv::new_reg(get_rd_addr!(inst.inst) as u64);
    ...
    pub fn translate_fcvt_d_wu(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) { 
        let mut tcg_lists = vec![];
        let rs1 = TCGv::new_reg(get_rs1_addr!(inst.inst) as u64);
        let rd  = TCGv::new_reg(get_rd_addr!(inst.inst) as u64);
    ...
    pub fn translate_fcvt_l_s (&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) { 
        let mut tcg_lists = vec![];
        let rs1 = TCGv::new_reg(get_rs1_addr!(inst.inst) as u64);
        let rd  = TCGv::new_reg(get_rd_addr!(inst.inst) as u64);
    ...
    pub fn translate_fcvt_lu_s(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) { 
        let mut tcg_lists = vec![];
        let rs1 = TCGv::new_reg(get_rs1_addr!(inst.inst) as u64);
        let rd  = TCGv::new_reg(get_rd_addr!(inst.inst) as u64);
    ...
    pub fn translate_fcvt_s_l (&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) { 
        let mut tcg_lists = vec![];
        let rs1 = TCGv::new_reg(get_rs1_addr!(inst.inst) as u64);
        let rd  = TCGv::new_reg(get_rd_addr!(inst.inst) as u64);
    ...
    pub fn translate_fcvt_s_lu(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) { 
        let mut tcg_lists = vec![];
        let rs1 = TCGv::new_reg(get_rs1_addr!(inst.inst) as u64);
        let rd  = TCGv::new_reg(get_rd_addr!(inst.inst) as u64);
    ...
    pub fn translate_fcvt_l_d (&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) { 
        let mut tcg_lists = vec![];
        let rs1 = TCGv::new_reg(get_rs1_addr!(inst.inst) as u64);
        let rd  = TCGv::new_reg(get_rd_addr!(inst.inst) as u64);
    ...
    pub fn translate_fcvt_lu_d(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) { 
        let mut tcg_lists = vec![];
        let rs1 = TCGv::new_reg(get_rs1_addr!(inst.inst) as u64);
        let rd  = TCGv::new_reg(get_rd_addr!(inst.inst) as u64);
    ...
    pub fn translate_fcvt_d_l (&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) { 
        let mut tcg_lists = vec![];
        let rs1 = TCGv::new_reg(get_rs1_addr!(inst.inst) as u64);
        let rd  = TCGv::new_reg(get_rd_addr!(inst.inst) as u64);
    ...
    pub fn translate_fcvt_d_lu(&mut self, inst: &InstrInfo) -> (bool, Vec<TCGOp>) { 
        let mut tcg_lists = vec![];
        let rs1 = TCGv::new_reg(get_rs1_addr!(inst.inst) as u64);
        let rd  = TCGv::new_reg(get_rd_addr!(inst.inst) as u64);
